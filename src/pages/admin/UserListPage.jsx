    ...
    const fetchUsers = async () => {
      ...
      try {
        const response = await fetch(
            `https://localhost:7217/user-pagings?pageIndex=${currentPage}&pageSize=5`
        );
  ...
  return (
      <div className={`min-h-screen flex flex-col ${isDarkMode ? 'dark' : ''}`}>
        ...
        <div className="flex flex-1">
          ...
          />
          <div className="flex-1 p-4 bg-green-100 content-container">
            {isLoading ? (
                <div className="loading-spinner" />
            ) : (
                <div className="bg-green-100 rounded-lg overflow-hidden p-4">
